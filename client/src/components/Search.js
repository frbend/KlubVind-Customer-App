...
class Search extends React.Component{
    ...
    getData = () => {
        ...
        Axios.get('https://klub-vind-customer-9vi9fo6ix-frank-bendiks-projects.vercel.app/list/Kommune/' + this.state.search)
          .then(responseData => {
    ...
    prevItem =() =>{
        Axios.get('https://klub-vind-customer-9vi9fo6ix-frank-bendiks-projects.vercel.app/list/Kommune/:Kommune/prev/'+ this.state.responseData[0].id)
        .then(prevData =>{
    ...
    nextItem =() =>{
        Axios.get('https://klub-vind-customer-9vi9fo6ix-frank-bendiks-projects.vercel.app/list/Kommune/:Kommune/next/'+ this.state.responseData[0].id)
        .then(newData =>{
